...
if __name__ == '__main__':
    ...
    parser.add_argument("--input_dir", default='/nfsroot/DATA/IL_Research/datasets/Calvin/calvin_debug_dataset/', type=str, help="Original dataset directory.")
    parser.add_argument("--output_dir", default='/nfsroot/DATA/IL_Research/datasets/Calvin/calvin_debug_dataset/calvin_lmdb', type=str, help="Original dataset directory.")
