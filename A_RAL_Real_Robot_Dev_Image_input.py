...
with torch.no_grad():
    ...
    # language = "open the upper drawer"
    language = "pick bread and place into drawer"
    # language = "close the upper drawer"
    ...
    image = cv2.imread("visualization/inference_image/rgb_camera_groundtruth0_0.png")
    ...
    cv2.imwrite(f"visualization/diffusion_inference.png", rgb_vis)  
